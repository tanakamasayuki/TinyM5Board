// Tier 0 for the ArduinoNessoN1: does this header stand on its own?
//
...
static_assert(TINYM5_BOARD::kBoardId == TinyM5::BoardId::NessoN1,
...
void setup()
{
  ...
  Serial.println(Board.Io2.isPresent());
