// Tier 0 for the M5AtomS3Lite: does this header stand on its own?
//
...
static_assert(TINYM5_BOARD::kBoardId == TinyM5::BoardId::AtomS3Lite,
              "the entry point selected a different board");
static_assert(TINYM5_BOARD::kFamily == TinyM5::Family::Atom,
