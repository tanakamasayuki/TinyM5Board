// Tier 0 for the M5StopWatch: does this header stand on its own?
//
...
static_assert(TINYM5_BOARD::kBoardId == TinyM5::BoardId::StopWatch,
              "the entry point selected a different board");
static_assert(TINYM5_BOARD::kFamily == TinyM5::Family::Other,
...
void setup()
{
  ...
  Serial.println(Board.Io.isPresent());
