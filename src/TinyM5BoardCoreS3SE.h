// TinyM5BoardCoreS3SE
//
// The CoreS3 without the camera. Every register brought up here is
...
class TinyM5BoardCoreS3SE {
 public:
  // ---- identity ----
  static constexpr TinyM5::BoardId kBoardId = TinyM5::BoardId::CoreS3SE;
  static constexpr TinyM5::Family kFamily = TinyM5::Family::Core;
  static constexpr const char *kName = "M5StackCoreS3SE";
...
#define TINYM5_BOARD TinyM5BoardCoreS3SE
...
inline TinyM5BoardCoreS3SE Board;
#endif
